          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url("index.php/Dosen_tampil/index") ?>">Dosen</a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url("index.php/Matkul_tampil/index") ?>">Matakuliah</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                ...
                <p class="copyright-text">
                  ...
                  <a href="https://www.instagram.com/ridhofaauzi/?hl=id" rel="nofollow"> Ridho Fauzi Grafika </a>
                </p>
              </div>
              <!-- End Single Widget -->
            </div>
